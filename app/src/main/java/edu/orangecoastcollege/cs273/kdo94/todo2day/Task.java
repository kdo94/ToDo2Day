...
public class Task {
    ...
    private int mIsDone; // In java would be a boolean, but because we are going to turn this
                        // into a database, we are using an integer
     ...
     * @param done Wheter the task is finished or not
     */
